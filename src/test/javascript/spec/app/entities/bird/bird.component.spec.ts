...
import { BirdComponent } from 'app/entities/bird/bird.component';
import { BirdService } from 'app/entities/bird/bird.service';
import { Bird } from 'app/shared/model/bird.model';

describe('Component Tests', () => {
    describe('Bird Management Component', () => {
        let comp: BirdComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BirdComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.birds[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
