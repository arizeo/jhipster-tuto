...
import { HabitatComponent } from 'app/entities/habitat/habitat.component';
import { HabitatService } from 'app/entities/habitat/habitat.service';
import { Habitat } from 'app/shared/model/habitat.model';

describe('Component Tests', () => {
    describe('Habitat Management Component', () => {
        let comp: HabitatComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HabitatComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.habitats[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
