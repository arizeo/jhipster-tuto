...
import { ReptileComponent } from 'app/entities/reptile/reptile.component';
import { ReptileService } from 'app/entities/reptile/reptile.service';
import { Reptile } from 'app/shared/model/reptile.model';

describe('Component Tests', () => {
    describe('Reptile Management Component', () => {
        let comp: ReptileComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ReptileComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.reptiles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
