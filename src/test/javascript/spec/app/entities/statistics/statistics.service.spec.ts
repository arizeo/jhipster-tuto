    ...
    describe('Statistics Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/statistics';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Statistics', () => {
                service.create(new Statistics(null)).subscribe(received => {
            ...
            it('should update a Statistics', () => {
                service.update(new Statistics(123)).subscribe(received => {
